...
base = f"LIA/speaker_partitions/{FOLDER}/{TYPE}/outputs"
...
if TYPE=='orig':
    dev_text = pd.read_csv(f"{base}/text_model/dev_predictions.csv")
    test_text = pd.read_csv(f"{base}/text_model/test_predictions.csv")
    datasets.update({"dev_text": dev_text, "test_text": test_text})
