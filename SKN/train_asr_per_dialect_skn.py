...
if INPUT != 'dialect_vc':
    ...
    DIALECT_FILES = {
        "Etelä-Pohjanmaa":            "Etelä-Pohjanmaa_train.csv",
        "Hämäläismurteet":            "Hämäläismurteet_train.csv",
        "Kaakkoismurteet":            "Kaakkoismurteet_train.csv",
        "Keski- ja Pohjois-Pohjanmaa":"Keski-_ja_Pohjois-Pohjanmaa_train.csv",
        "Lounaiset välimurteet":      "Lounaiset_välimurteet_train.csv",
        "Lounaismurteet":             "Lounaismurteet_train.csv",
        "Peräpohjola":                "Peräpohjola_train.csv",
        "Savolaismurteet":            "Savolaismurteet_train.csv",
    }
    train_dfs = []
    ...
    def ref_generator(filestart):
        ...
        for path, dir, files in os.walk("SKN/la_data"):
            for file in files:
                ...
                if file.startswith(filestart) and os.path.getsize(filepath) > 1_000_000:
...
if INPUT == 'dialect_vc':
    ...
    AREA_TO_VOICE = {
        ...
        "Hämäläismurteet":             "vc1",
        "Kaakkoismurteet":             "vc4",
        "Keski- ja Pohjois-Pohjanmaa": "vc8",
        "Lounaiset välimurteet":       "vc3",
        "Lounaismurteet":              "vc5",
        "Peräpohjola":                 "vc7",
        "Savolaismurteet":             "vc2",
    }

    # Build per-area datasets and apply the area-specific VC
