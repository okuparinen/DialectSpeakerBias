...
base = f"SKN/speaker_partitions/{FOLDER}/{TYPE}"

dev_best = pd.read_csv(f"{base}/validation_ASR_classification.csv")
test_best = pd.read_csv(f"{base}/test_ASR_classification.csv")
